...
<?php
    mysql_connect("localhost", "root", "bball6627") or die (mysql_error ());
    mysql_select_db("susquiz") or die('Could not connect to datase' .mysql_error());
?>
<div class="row">
    <div class="col-md-6">
        <div id="panel">
            ...
            <div id="results">
                <h3>Your Score: <?php if (isset($score)){echo $score . "/9";} ?></h3>
    ...
    <div class="col-md-6">
        <form action="#panel" enctype="application/x-www-form-urlencoded" method="post">
            ...
            <div class="row">
                <div class="col-md-12">
                    <input type="submit" value="Submit" id="submit" class="btn btn-primary col-sm-12 col-md-12">
                </div>
            </div>
        </form>
    </div>
    <div class="col-md-12">
        <div class="pull-left">
            &copy <a href="http://www.rosscreighton.com">Ross Creighton</a> 2014
        </div>
    </div>
</div>